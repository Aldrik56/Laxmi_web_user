            ...
            <div className="container-fluid px-5 pt-3 pb-5">
                <div className="row">
                    ...
                    <div className="col-12 col-lg-3 mt-4">
                        ...
                        <p>Telp : +6221 7198789, 7198857</p>
                        <p>Fax : +6221 7198806</p>
                        <p>Email: sales@laxmitailors.com</p>
                    </div>
                    <div className="col-12 col-lg-3 mt-4">
                        <h5>NEWSLETTER</h5>
                        <p>Subscribe for receiving the lastest update</p>
                        <div className="input-newsletter">
                            ...
                            <div className="d-flex flex-row">
                                ...
                                <button 
                                    type="submit" 
                                    className="btn btn-primary">Subcribe</button>                                                   
                            </div>
                        </div>
                    </div>
                    <div className="col-12 col-lg-3 mt-4">
